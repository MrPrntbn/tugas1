...
## *:information_source: InventorySmart*
...
## *:rocket: Instalasi*
#### :arrow_right: Download File Projek
...
#### :arrow_right: Set Up
Buka Terminal `gitbash` atau CMD di proyek folder Anda dan jalankan perintah dibawah ini:
```
composer install
```
```
